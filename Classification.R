...
C45_model1 <- J48(Continent~.,control = Weka_control(R = FALSE , C = 0.5 , M = 0),data = trainInput1)
C45_model2 <- J48(Continent~.,control = Weka_control(R = FALSE , C = 0.5 , M = 3), data = trainInput2)
C45_model3 <- J48(Continent~.,control = Weka_control(R = FALSE , C = 0.5 , M = 3), data = trainInput3)
C45_model4 <- J48(Continent~.,control = Weka_control(R = FALSE , C = 0.5, M = 0), data = trainInput4)
C45_model5 <- J48(Continent~.,control = Weka_control(R = FALSE , C = 0.5 , M = 0), data = trainInput5)
...
knn_p1 <- knn(train = trainInput1[,1:3], test = testInput1[,1:3],cl = inputlabels1, k=14.5,prob=TRUE)
knn_p2 <- knn(train = trainInput2[,1:3], test = testInput2[,1:3],cl = inputlabels2, k=14.5,prob=TRUE)
knn_p3 <- knn(train = trainInput3[,1:3], test = testInput3[,1:3],cl = inputlabels3, k=14.5,prob=TRUE)
knn_p4 <- knn(train = trainInput4[,1:3], test = testInput4[,1:3],cl = inputlabels4, k=14.5,prob=TRUE)
knn_p5 <- knn(train = trainInput5[,1:3], test = testInput5[,1:3],cl = inputlabels5, k=14.5,prob=TRUE)

rip_m1 <- JRip(Continent~.,control = Weka_control(O = 0 , F = 5 , N = 1),data = trainInput1)
rip_m2 <- JRip(Continent~.,control = Weka_control(O = 0 , F = 5 , N = 1),data = trainInput2)
rip_m3 <- JRip(Continent~.,control = Weka_control(O = 0 , F = 5 , N = 1),data = trainInput3)
rip_m4 <- JRip(Continent~.,control = Weka_control(O = 0 , F = 5 , N = 1),data = trainInput4)
rip_m5 <- JRip(Continent~.,control = Weka_control(O = 0 , F = 5 , N = 1),data = trainInput5)
...
rip_c1 <- confusionMatrix(rip_p1,inputset[trainIndex1==2,4])
rip_c2 <- confusionMatrix(rip_p2,inputset[trainIndex2==2,4])
rip_c3 <- confusionMatrix(rip_p3,inputset[trainIndex3==2,4])
rip_c4 <- confusionMatrix(rip_p4,inputset[trainIndex4==2,4])
rip_c5 <- confusionMatrix(rip_p5,inputset[trainIndex5==2,4])
